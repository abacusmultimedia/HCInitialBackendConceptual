...
namespace zero.Persistence.Migrations
{
    ...
    [Migration("20230224182411_newfieldsact")]
    partial class newfieldsact
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POSERP.Entities.INV_MSD_PackingSize", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("POSERP.Entities.SD_POS_Invoice_Template", b =>
                {
                    b.Property<long>("DocumentNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SD_POS_Invoice_Template");
                });
            ...
            modelBuilder.Entity("POSERP.Entities.SD_POS_InvoiceDetail_Template", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SD_POS_InvoiceDetail_Template");
                });
            ...
            modelBuilder.Entity("POSERP.Entities.SD_POS_InvoiceDetail", b =>
                {
                    b.HasOne("POSERP.Entities.INV_MSD_SubItemCode", "SubItemCode")
            ...
            modelBuilder.Entity("POSERP.Entities.SD_POS_InvoiceDetail_Template", b =>
                {
                    ...
                    b.HasOne("POSERP.Entities.SD_POS_Invoice_Template", "SD_POS_Invoice")
                        .WithMany("SD_POS_InvoiceDetail")
                        .HasForeignKey("SD_POS_InvoiceDocumentNo")
                        .OnDelete(DeleteBehavior.Restrict);
